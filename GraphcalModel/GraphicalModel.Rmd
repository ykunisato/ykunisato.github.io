...
# preview版のRstudioでMarkdownがStanに対応！

Markdownにstanコードを直書きして，チャンクの部分{stan output.var="モデル名"}ってやって実行する。すると，Stanコードがコンパイルされて，指定したモデル名で保存される。あとはサンプリングだけでよろし。詳しくは，[@kazutanの資料](http://qiita.com/kazutan/items/6cc162bc3c4b1b9062f2)を参照。
